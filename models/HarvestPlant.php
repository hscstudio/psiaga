...
class HarvestPlant extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'note1' => Yii::t('app', 'Keterangan 1'),
            'note2' => Yii::t('app', 'Keterangan 2'),
            'note3' => Yii::t('app', 'Keterangan 3'),
            'note4' => Yii::t('app', 'Keterangan 4'),
            'note5' => Yii::t('app', 'Keterangan 5'),
